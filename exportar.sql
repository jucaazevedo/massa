--------------------------------------------------------
--  Arquivo criado - Segunda-feira-Julho-10-2017   
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Package Body PKG_GERA_MASSA
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "CNTRPCSM"."PKG_GERA_MASSA" AS
       ...
       begin
            ...
            (
                ...
                COD_PRODUTO_TE05, VLR_TRAN_TE05, IND_MOVIMENTACAO,
            ...
            (
                ...
                p_codigo_produto, p_vlr_transacao, p_ind_movimentacao,
        ...
        exception
         ...
         for rc in (select distinct nro_linha_arquivo,dsc_linha_arquivo,
                    ...
                    from (select nro_linha_arquivo,dsc_linha_arquivo,
                          ...
                          from TBL_OUTPUT_MASSA_DADOS m
                          where substr(m.dsc_linha_arquivo, 1, 2) IN ('05', '06', '46')
         ...
         for rc in (select distinct m.nro_linha_arquivo,
                      ...
                      where m.nro_identif_gera_massa = p_numero_geracao_massa
                      and substr(m.dsc_linha_arquivo, 1, 2) IN ('05', '06', '46')
                      and substr(m.dsc_linha_arquivo, 3, 2) = '00'
